...
public class Ejercicio4 {
    public static void main(String[] args) {
        ...
        for (int f = 0; f < cadena1.length(); f++) {
            ...
            if (character == 'a') {//Hacemos una condición con cada  vocal y hacemos un bucle que pase por cada letra y así detecte cuantas vocales hay y se sumarán a una variable
                a++;
            }
            if (character == 'e') {
                e++;
